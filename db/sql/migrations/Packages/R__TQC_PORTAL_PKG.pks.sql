...
--
-- TQC_PORTAL_PKG  (Package) 
--
CREATE OR REPLACE PACKAGE TQ_CRM."TQC_PORTAL_PKG"
AS
/******************************************************************************
...
******************************************************************************/
   ...
   TYPE client_dtls_rec IS RECORD (
      ...
      clnt_cont_name            varchar2(200),
      clnt_cont_phone              varchar2(200),
      clnt_passport           varchar2(200),
      prp_idntf_doc_used    lms_proposers.prp_idntf_doc_used%TYPE
   );
