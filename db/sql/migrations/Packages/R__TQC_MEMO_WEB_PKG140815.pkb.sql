--
-- TQC_MEMO_WEB_PKG140815  (Package Body) 
--
CREATE OR REPLACE PACKAGE BODY TQ_CRM.TQC_MEMO_WEB_PKG140815 AS
...
--          RAISE_ERROR('Error updating memo record no...' || v_mtyp_code);
  ...
  END;
  --23022015NEW
   PROCEDURE updateMemo23022015(v_user           VARCHAR2,
                       v_appl_lvl       VARCHAR2,
                       v_memo_date      DATE,
                       v_policy_number  VARCHAR2,
                       v_quot_no        VARCHAR2,
