--
-- TQC_ROLES_CURSORBK280514  (Package) 
--
CREATE OR REPLACE PACKAGE TQ_CRM.TQC_ROLES_CURSORBK280514 AS
/******************************************************************************
...
******************************************************************************/
    ...
    TYPE Sys_roles_ref IS REF CURSOR RETURN Sys_roles_rec;
    FUNCTION Get_Sys_Roles(v_syscode IN TQC_SYSTEMS.SYS_CODE%TYPE) RETURN  Sys_roles_ref;
    ...
    TYPE Sys_UsrRoles_ref IS REF CURSOR RETURN  Sys_UsrRoles_rec;    
    FUNCTION Get_User_Roles(v_syscode IN TQC_SYSTEMS.SYS_CODE%TYPE,
                            v_user    IN TQC_USERS.USR_CODE%TYPE) RETURN  Sys_UsrRoles_ref;
    ...
    TYPE Role_Areas_rec IS RECORD(
        ...
        SRPRC_CODE          TQC_SYS_ROLES_PROCESSES.SRPRC_CODE%TYPE);
    TYPE Role_Areas_ref IS REF CURSOR RETURN Role_Areas_rec;
       FUNCTION Get_Role_Areas(v_Process       IN TQC_SYS_PROCESSES.SPRC_CODE%TYPE,
                            v_roleProcess   IN TQC_SYS_ROLES_PROCESSES.SRPRC_CODE%TYPE) RETURN  Role_Areas_ref;
    ...
    TYPE ProcessRole_Areas_ref  IS REF CURSOR RETURN ProcessRole_Areas_rec;
    FUNCTION GetProcessRoleArea  (v_Process       IN TQC_SYS_PROCESSES.SPRC_CODE%TYPE,
                                  v_sysRoleCode    IN  TQC_SYS_ROLES_PROCESSES.SRPRC_SRLS_CODE%TYPE) RETURN  ProcessRole_Areas_ref;                
    ...
    TYPE Role_Processes_ref IS REF CURSOR RETURN Role_Processes_rec;
    FUNCTION GetRoleProcesses (v_sysCode        IN  TQC_SYS_PROCESSES.SPRC_SYS_CODE%TYPE,
                               v_sysRoleCode    IN  TQC_SYS_ROLES_PROCESSES.SRPRC_SRLS_CODE%TYPE) RETURN Role_Processes_ref;
    ...
    TYPE Role_SubAreas_ref IS REF CURSOR RETURN Role_SubAreas_rec;
    FUNCTION Get_Role_SubAreas(v_ProcessArea       IN TQC_SYS_PROCESS_AREAS.SPRCA_CODE%TYPE,
                               v_roleProcessArea   IN TQC_SYS_ROLES_PRCS_AREA.SRPRA_SRPRC_CODE%TYPE) RETURN  Role_SubAreas_ref;
    ...
    TYPE ProcessRole_SubAreas_ref IS REF CURSOR RETURN ProcessRole_SubAreas_rec;
    FUNCTION GetProcessRole_SubAreas(v_ProcessArea       IN TQC_SYS_PROCESS_AREAS.SPRCA_CODE%TYPE,
                                     ...
                                     v_Process           IN TQC_SYS_PROCESSES.SPRC_CODE%TYPE) RETURN  ProcessRole_SubAreas_ref;
    ...
    FUNCTION Get_Users RETURN Users_ref; 
   ...
   FUNCTION get_all_individual_users RETURN Users_ref;
    ...
    FUNCTION Get_Systems RETURN Systems_ref;   
    ...
    TYPE User_Systems_ref IS REF CURSOR RETURN User_Systems_rec;
    FUNCTION Get_User_Systems (v_user       IN TQC_USERS.USR_CODE%TYPE) RETURN User_Systems_ref;
    FUNCTION Get_system_Users (v_system IN TQC_USER_SYSTEMS.USYS_SYS_CODE%TYPE) RETURN  Users_ref;
    ...
    TYPE user_unassigned_systems_ref IS REF CURSOR RETURN user_unassigned_systems_rec;
    ...
    TYPE user_unassigned_roles_ref IS REF CURSOR RETURN user_unassigned_roles_rec;
    ...
    TYPE user_unassigned_divisions_ref IS REF CURSOR RETURN user_unassigned_divisions_rec;
    ...
    FUNCTION Get_System_Processes (v_sysCode    IN TQC_SYS_PROCESSES.SPRC_SYS_CODE%TYPE) RETURN Sys_Processes_ref;
    ...
    FUNCTION GetOrganizations RETURN Organizations_ref;
    FUNCTION Get_user_Orgs(v_usrCode      IN  TQC_USER_BRANCHES.USB_USR_CODE%TYPE) RETURN Organizations_ref;
    FUNCTION Get_user_assigned_Orgs(v_user_code   IN TQC_USERS.USR_CODE%TYPE) RETURN Organizations_ref ;
    ...
    FUNCTION GetRegions(v_orgCode   IN  TQC_REGIONS.REG_ORG_CODE%TYPE)RETURN Regions_ref;
    FUNCTION Get_User_assigned_Regions(v_orgCode   IN  TQC_REGIONS.REG_ORG_CODE%TYPE,
      v_user_code   IN TQC_USERS.USR_CODE%TYPE ) RETURN Regions_ref ;
    ...
    FUNCTION GetBranches(v_regCode   IN TQC_BRANCHES.BRN_REG_CODE%TYPE) RETURN Branches_ref;
    ...
    TYPE UsrBranches_ref IS REF CURSOR RETURN UsrBranches_rec;
    FUNCTION GetUserBranches(v_usrCode      IN  TQC_USER_BRANCHES.USB_USR_CODE%TYPE,
                             v_OrgCode      IN TQC_ORGANIZATIONS.ORG_CODE%TYPE) RETURN UsrBranches_ref;
                             
    FUNCTION get_user_branches(
            v_usrCode      IN   TQC_USER_BRANCHES.USB_USR_CODE%TYPE
            ) RETURN UsrBranches_ref;
    FUNCTION GetBranchesbyOrg(v_orgCode   IN TQC_ORGANIZATIONS.ORG_CODE%TYPE) RETURN Branches_ref;
    ...
    TYPE default_branch_ref IS REF CURSOR RETURN  default_branch_rec;  
  ...
  TYPE default_details_ref IS REF CURSOR RETURN  default_details_rec; 
  FUNCTION get_user_defaults (
    ...
    TYPE default_division_ref IS REF CURSOR RETURN  default_division_rec; 
...
PROCEDURE   Edit_Role (v_roleProcess       IN  TQC_SYS_ROLES_PROCESSES.SRPRC_CODE%TYPE,
    ...
    PROCEDURE Restore_Role (v_roleProcess       IN  TQC_SYS_ROLES_PROCESSES.SRPRC_CODE%TYPE);
    
    PROCEDURE Drop_Role (v_roleProcess       IN  TQC_SYS_ROLES_PROCESSES.SRPRC_CODE%TYPE);
    ...
    PROCEDURE enableDisableBranch(v_usrBranchCode       IN TQC_USER_BRANCHES.USB_CODE%TYPE);
    
    PROCEDURE makeDefaultBranch(v_usrBranchCode       IN TQC_USER_BRANCHES.USB_CODE%TYPE);
...
TYPE userAssignedSystems_ref IS REF CURSOR RETURN userAssignedSystems_rec; 
FUNCTION getAllUserAssignedSystems (v_user_code NUMBER) RETURN  userAssignedSystems_ref; 
      
FUNCTION SYS_POST_NAME(v_spost_code NUMBER ) RETURN VARCHAR2;
FUNCTION GetRegionsFiltered(v_orgCode   IN  TQC_REGIONS.REG_ORG_CODE%TYPE,v_user_code TQC_USER_BRANCHES.USB_USR_CODE%TYPE )RETURN Regions_ref;
...
PROCEDURE Revoke_User_BranchByOrg (v_user         IN  TQC_USER_BRANCHES.USB_USR_CODE%TYPE,
                             v_org_code  IN  TQC_REGIONS.REG_ORG_CODE%TYPE,
                             v_err OUT VARCHAR2);
FUNCTION Get_user_OrgsFiltered(v_usrCode  IN  TQC_USER_BRANCHES.USB_USR_CODE%TYPE) RETURN Organizations_ref;
