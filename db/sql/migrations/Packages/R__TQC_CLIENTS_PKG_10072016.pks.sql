...
--
-- TQC_CLIENTS_PKG_10072016  (Package) 
--
CREATE OR REPLACE PACKAGE TQ_CRM.tqc_clients_pkg_10072016
AS
/******************************************************************************
...
*/
   TYPE tqc_acccounts_agents_rec IS RECORD(
     ...
     v_act_type_sht_desc    tqc_account_types.ACT_TYPE_SHT_DESC%TYPE ,
     v_agn_bank_acc_no      tqc_agencies.agn_bank_acc_no%TYPE ,
     v_agn_payment_freq      tqc_agencies.agn_payment_freq%type
 );
   TYPE tqc_accounts_agents_cursor IS REF CURSOR
      RETURN tqc_acccounts_agents_rec;
   ...
   TYPE clients_detls_rec IS RECORD (
      ...
      clnt_cntct_relationship               tqc_clients.clnt_cntct_relationship%type,
        clnt_guardn_name               tqc_clients.clnt_guardn_name%type,
        clnt_guardn_age               tqc_clients.clnt_guardn_age%type,
        clnt_guardn_relationship               tqc_clients.clnt_guardn_relationship%type
   );
   ...
   TYPE GETCLTTYPES_REC IS RECORD(
      CLNTY_CLNT_TYPE                   TQC_CLIENT_TYPES.CLNTY_CLNT_TYPE%TYPE,
      CLNTY_TYPE                             TQC_CLIENT_TYPES.CLNTY_TYPE%type
    );
    
  TYPE getCltTypes_ref IS REF CURSOR RETURN getCltTypes_rec;
...
TYPE getCltTypes_ref IS REF CURSOR RETURN getCltTypes_rec;  
  ...
  /* TYPE gis_clients_rec IS RECORD (
   ...
   TYPE gis_clients_ref IS REF CURSOR
      ...
      TYPE gis_clients_rec IS RECORD(
        ...
        CLNT_BANK_CELL_NO            TQC_CLIENTS.CLNT_BANK_CELL_NO%TYPE,
        CLT_CELL_NO                  TQC_CLIENTS.CLT_CELL_NO%type,
        COU_DOM_CODE                 TQC_COUNTRIES.COU_CODE%TYPE,
         clnt_occupation             TQC_CLIENTS.clnt_occupation%type, 
         clnt_occ_code               TQC_CLIENTS.clnt_occ_code%type
 ...
 TYPE client_dd_rec IS RECORD(
      ...
      clnt_id_reg_no          tqc_clients.clnt_id_reg_no%type, 
      clnt_pin                tqc_clients.clnt_pin%type, 
      clnt_dd_account_name    tqc_clients.clnt_dd_account_name%type, 
      clnt_dd_account_no      tqc_clients.clnt_dd_account_no%type, 
      clnt_dd_bbr_code        tqc_clients.clnt_dd_bbr_code%type,
      clnt_dd_branch          varchar2(100)
   
   );
   
   TYPE client_dd_ref IS REF CURSOR
   RETURN client_dd_rec;
   FUNCTION get_client_dd_details(v_clnt_code IN NUMBER) RETURN client_dd_ref;
