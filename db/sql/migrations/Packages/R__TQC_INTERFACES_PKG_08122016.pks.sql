--
-- TQC_INTERFACES_PKG_08122016  (Package) 
--
CREATE OR REPLACE PACKAGE TQ_CRM.tqc_interfaces_pkg_08122016
IS
   ...
   TYPE orgcostrefcur IS REF CURSOR
      RETURN orgcostrec;

   TYPE orgcosttable IS TABLE OF orgcostrec
   ...
   TYPE branchrefcur IS REF CURSOR
      RETURN branchrec;
   ...
   TYPE menurefcur2 IS REF CURSOR
      RETURN menurec2;
   ...
   TYPE type_systems_ref_cur IS REF CURSOR
      RETURN type_systems_rec;
...
FUNCTION get_task_assignee (
   ...
   */
   ...
   TYPE gin_treaty_accounts_cursor IS REF CURSOR
      RETURN gin_treaty_accounts_rec;
...
END tqc_interfaces_pkg_08122016; 
