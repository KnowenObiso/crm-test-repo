--
-- TQC_PORTAL_CURSOR01112015  (Package) 
--
CREATE OR REPLACE PACKAGE TQ_CRM."TQC_PORTAL_CURSOR01112015" AS
/******************************************************************************
...
FUNCTION getProductCategories(v_sysCode NUMBER, v_prodCode IN NUMBER DEFAULT NULL, v_agentCode IN NUMBER DEFAULT NULL) RETURN product_categories_ref;
