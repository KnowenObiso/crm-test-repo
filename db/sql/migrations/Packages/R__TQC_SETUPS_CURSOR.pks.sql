...
--
-- TQC_SETUPS_CURSOR  (Package) 
--
CREATE OR REPLACE PACKAGE TQ_CRM.tqc_setups_cursor
AS
   /******************************************************************************
...
TYPE bank_regions_ref IS REF CURSOR
  ...
  TYPE agency_info_rec IS RECORD (
      ...
      agn_updated_by             tqc_agencies.agn_updated_by%TYPE,
      agn_updated_on             tqc_agencies.agn_updated_on%TYPE
   );
 ...
 PROCEDURE get_agency_info (
  ...
  PROCEDURE get_service_provider_types (
   ...
   TYPE service_providers_rec IS RECORD (
      ...
      cou_zip_code             tqc_countries.cou_zip_code%TYPE,
      spr_reg_no               tqc_service_providers.spr_reg_no%TYPE,
      spr_postal_code          tqc_service_providers.spr_postal_code%TYPE,
      spr_id_type               tqc_service_providers.spr_id_type%TYPE,
      spr_id_no          tqc_service_providers.spr_id_no%TYPE
   );
 ...
 FUNCTION get_em_template (v_sys_code IN NUMBER)
  ...
  TYPE orgdivlevelstype_rec IS RECORD (
      ...
      dlt_type        tqc_org_division_levels_type.dlt_type%TYPE,
      acc_type1   VARCHAR2 (50),
      acc_type2   VARCHAR2 (50),
      acc_type3   VARCHAR2 (50),
      acc_type4   VARCHAR2 (50)
   );
   ...
   TYPE orgsubdivisions_rec IS RECORD (
      ...
      OSD_LOCATION_CODE        tqc_org_subdivisions.OSD_LOCATION_CODE%TYPE,
      OSD_LOCATION            tqc_org_subdivisions.OSD_LOCATION%TYPE
   );
...
TYPE provider_contacts_rec IS RECORD (
      spr_cnt_code         TQC_SPR_CONTACT_PERSONS.spr_code%TYPE,
      v_spr_code           TQC_SPR_CONTACT_PERSONS.spr_code%TYPE,
      SPR_CNT_NAME         TQC_SPR_CONTACT_PERSONS.SPR_CNT_NAME%TYPE,
      SPR_CNT_TITLE        TQC_SPR_CONTACT_PERSONS.SPR_CNT_TITLE%TYPE,
      SPR_CNT_OFFICE_TEL   TQC_SPR_CONTACT_PERSONS.SPR_CNT_OFFICE_TEL%TYPE,
      SPR_CNT_HOME_TEL     TQC_SPR_CONTACT_PERSONS.SPR_CNT_HOME_TEL%TYPE,
      SPR_CNT_EMAIL        TQC_SPR_CONTACT_PERSONS.SPR_CNT_EMAIL%TYPE,
      SPR_NAME             tqc_service_providers.SPR_NAME%TYPE
	  
     
   );

   TYPE provider_contacts_ref IS REF CURSOR
      RETURN provider_contacts_rec;
 PROCEDURE provider_contacts_prc (
      v_spr_code                        TQC_SPR_CONTACT_PERSONS.spr_code%TYPE,
      v_provider_contacts_ref   OUT     provider_contacts_ref
   );
TYPE bancassurance_branches_rec IS RECORD (
      v_bbb_bbb_code          tqc_bancassurance_branches.bbb_code%TYPE,
      v_bbb_bbr_code          tqc_bancassurance_branches.bbb_bbr_code%TYPE,
      v_bbb_branch_name       tqc_bancassurance_branches.bbb_branch_name%TYPE,
      v_bbb_remarks           tqc_bancassurance_branches.bbb_remarks%TYPE,
      v_bbb_sht_desc          tqc_bancassurance_branches.bbb_sht_desc%TYPE,
      v_bbb_date_created      tqc_bancassurance_branches.bbb_date_created%TYPE,
      v_bbb_created_by        tqc_bancassurance_branches.bbb_created_by%TYPE,
      v_bbb_physical_addrs    tqc_bancassurance_branches.bbb_physical_addrs%TYPE,
      v_bbb_postal_addrs      tqc_bancassurance_branches.bbb_postal_addrs%TYPE,
      v_bbb_kba_code          tqc_bancassurance_branches.bbb_kba_code%TYPE,
      v_bbb_bnkt_code         tqc_bancassurance_branches.bbb_bnkt_code%TYPE,
      v_bbb_bnkt_sht_desc     tqc_bancassurance_branches.bbb_bnkt_sht_desc%TYPE,
      v_bbb_email             tqc_bancassurance_branches.bbb_email%TYPE,
      v_bbb_person_name       tqc_bancassurance_branches.bbb_person_name%TYPE,
      v_bbb_person_email      tqc_bancassurance_branches.bbb_person_email%TYPE,
      v_bbb_person_cou_code   tqc_bancassurance_branches.bbb_person_cou_code%TYPE,
      v_bbb_person_phone      tqc_bancassurance_branches.bbb_person_phone%TYPE,
      v_bbb_ter_code          tqc_bancassurance_branches.bbb_ter_code%TYPE
   );

   TYPE bancassurance_branches_ref IS REF CURSOR
      RETURN bancassurance_branches_rec;
   
PROCEDURE get_bancassurance_branches (
      v_bbr_code                           tqc_bank_branches.bbr_code%TYPE,
      v_bancassurance_branches_ref   OUT   bancassurance_branches_ref
   ); 
 TYPE fa_agent_details_rec IS RECORD (
      fa_agn_org_code          tqc_fa_agents.fa_agn_org_code%TYPE,
      fa_agn_sht_desc          tqc_fa_agents.fa_agn_sht_desc%TYPE,
      fa_team_code             tqc_fa_agents.fa_team_code%TYPE,
      fa_agn_name              tqc_fa_agents.fa_agn_name%TYPE,
      fa_agent_code            tqc_fa_agents.fa_agent_code%TYPE 
   );

   TYPE getFaAgents_ref IS REF CURSOR
      RETURN fa_agent_details_rec;

   FUNCTION getFaAgents
      RETURN getFaAgents_ref; 
              
END tqc_setups_cursor;
/