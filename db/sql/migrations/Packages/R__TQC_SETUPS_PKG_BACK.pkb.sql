--
-- TQC_SETUPS_PKG_BACK  (Package Body) 
--
CREATE OR REPLACE PACKAGE BODY TQ_CRM.tqc_setups_pkg_back
AS
         ...
         BEGIN
            ...
            INSERT INTO tqc_banks
                        (bnk_code, bnk_bank_name,
                         ...
                         dd_format_desc, bnk_forwarding_bnk_code,
                 ...
                 VALUES (tqc_bnk_code_seq.NEXTVAL, v_bnk_bank_name,
                         ...
                         v_dd_format_desc, v_bnk_forwarding_bnk_code,
