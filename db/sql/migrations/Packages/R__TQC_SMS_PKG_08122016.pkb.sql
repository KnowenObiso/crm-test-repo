--
-- TQC_SMS_PKG_08122016  (Package Body) 
--
CREATE OR REPLACE PACKAGE BODY TQ_CRM.tqc_sms_pkg_08122016
AS
   ...
   BEGIN
      ...
      BEGIN
         ...
         v_sms_msg := tqc_memos_dbpkg.process_gis_pol_memo ( 
                                 v_pol_code, 
                                 v_clm_no, 
                                 v_sms_msg, 
                                 v_app_lvl,
      ...
      EXCEPTION
         ...
         THEN
            RAISE_ERROR(
             'Unable to merge sms memo! '||SQLERRM
         );
      END;
--        RAISE_ERROR(
