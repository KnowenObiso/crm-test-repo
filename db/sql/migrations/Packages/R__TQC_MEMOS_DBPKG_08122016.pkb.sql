--
-- TQC_MEMOS_DBPKG_08122016  (Package Body) 
--
CREATE OR REPLACE PACKAGE BODY TQ_CRM.tqc_memos_dbpkg_08122016
AS
   /******************************************************************************
      NAME:       tqc_memos_pkg
      PURPOSE:
...
--        vcsd_salvage_desc VARCHAR2(1000);
--        
...
--                and ((cpv_ggt_trans_no =v_trans_no) or v_trans_no is null)
...
--            THEN
--               SELECT csd_max_bid, csd_min_bid,csd_approved_value, csd_salvage_desc
--                 INTO vcsd_max_bid, vcsd_min_bid,v_approved_value, vcsd_salvage_desc
...
--     
--            lv_temp_txt := REPLACE (lv_temp_txt, '[BANKBRANCH]', v_bbr_branch_name);
--            lv_temp_txt :=REPLACE (lv_temp_txt, '[REGNO]', v_cmb_ipu_property_id);
--            lv_temp_txt :=REPLACE (lv_temp_txt, '[RISKID]', v_cmb_ipu_property_id);
--            lv_temp_txt :=REPLACE (lv_temp_txt, '[INSURED]', v_cmb_prp_sht_desc);
--            lv_temp_txt :=REPLACE (lv_temp_txt, '[EXCESSAMOUNT]', v_excess_amount);
--            lv_temp_txt :=REPLACE (lv_temp_txt, '[AMOUNT]', v_cpv_amount);
--            lv_temp_txt :=REPLACE (lv_temp_txt, '[PAYMENTMODE]', v_cpv_payment_mode );  
--            lv_temp_txt :=REPLACE (lv_temp_txt, '[ACCOUNTNO]', v_spr_bank_acc_no );  
--            lv_temp_txt :=REPLACE (lv_temp_txt, '[SALVAGEDESCRIPTION]', vcsd_salvage_desc ); 
--              lv_temp_txt :=
