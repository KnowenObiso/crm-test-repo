--
-- TQC_DOCUMENTS_REGISTER  (Table) 
--
CREATE TABLE TQ_CRM.TQC_DOCUMENTS_REGISTER
(
  DOCR_ID             INTEGER,
  DOCR_DOC_NAME       VARCHAR2(50 BYTE),
  ...
  DOCR_DISPATCHED     VARCHAR2(1 BYTE)          DEFAULT 'N',
  DOCR_DISPATCH_DT    DATE,
  DOCR_DISPATCHABLE   VARCHAR2(3 BYTE)          DEFAULT 'P'
)
TABLESPACE CRMDATA
PCTUSED    0
PCTFREE    10
