--
-- TQC_AGENCIES_OBJ  (Type) 
--
CREATE OR REPLACE TYPE TQ_CRM."TQC_AGENCIES_OBJ"                                          as object (
  AGN_CODE               NUMBER(12)             ,
  AGN_ACT_CODE           NUMBER(8),
  AGN_SHT_DESC           VARCHAR2(15 BYTE)      ,
  AGN_NAME               VARCHAR2(100 BYTE)     ,
  AGN_PHYSICAL_ADDRESS   VARCHAR2(100 BYTE),
  AGN_POSTAL_ADDRESS     VARCHAR2(50 BYTE),
  AGN_TWN_CODE           NUMBER(8),
  AGN_COU_CODE           NUMBER(8),
  AGN_EMAIL_ADDRESS      VARCHAR2(50 BYTE),
  ...
  AGN_TEL1               VARCHAR2(20 BYTE),
  AGN_TEL2               VARCHAR2(20 BYTE),
  AGN_FAX                VARCHAR2(15 BYTE),
  ...
  AGN_RUNOFF             CHAR(1 BYTE)           ,
  AGN_LICENSED           VARCHAR2(1 BYTE)      ,
  AGN_LICENSE_GRACE_PR   NUMBER(10),
  AGN_OLD_ACC_NO         VARCHAR2(20 BYTE),
  AGN_STATUS_REMARKS     VARCHAR2(2 BYTE),
  AGN_VAT_APPLICABLE     VARCHAR2(1),
  AGN_WHTAX_APPLICABLE   VARCHAR2(1) 
); 
/