...
public class ActiveDirectory {
   ...
   */
    ...
    public static LdapContext getConnection(String username, String password,
                                            String domainName,
                                            String serverName) throws NamingException {

        if (domainName == null) {
            try {
                //String fqdn = java.net.InetAddress.getLocalHost().getCanonicalHostName();
                //String fqdn = "turnkeyAfrica.net";
                //domainName = fqdn;
                //System.out.println(fqdn.split("\\.").length);
        ...
        try {
            ...
            if (username.contains("@")) {
                ...
                String authenticatedUser =
                    (String)context.getEnvironment().get(Context.SECURITY_PRINCIPAL);
                if (authenticatedUser.contains("@")) {
                    domainName =
                            authenticatedUser.substring(authenticatedUser.indexOf("@") +
                                                        1);
                }
            }
    ...
    public static User[] getUsers(LdapContext context) throws NamingException {
        ...
        if (authenticatedUser.contains("@")) {
            ...
            NamingEnumeration answer =
                context.search(toDC(domainName), "(objectClass=user)",
                               controls);
            try {
    ...
    public static class User {
        ...
        public void changePassword(String oldPass, String newPass,
                                   ...
                                   LdapContext context) throws java.io.IOException,
                                                               NamingException {
