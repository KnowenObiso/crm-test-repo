 ...
 * @date Jan 25, 2017
 * @version 1.0
 * @description : ClientDirectorNoGen.java
 */


public class ClientDirectorNoGen implements IdentifierGenerator {
    
    private String DEFAULT_SEQUENCE_NAME = "TQC_CLNTDIR_CODE_SEQ";
