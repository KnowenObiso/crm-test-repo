 ...
 * @date Jan 25, 2017
 * @version 1.0
 * @description : SourceOfIncomeNoGen.java
 */

public class SourceOfIncomeNoGen implements IdentifierGenerator {
    
    private String DEFAULT_SEQUENCE_NAME = "TQC_INCOME_CODE_SEQ";
