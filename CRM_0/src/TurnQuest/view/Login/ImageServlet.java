...
public class ImageServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request,
        ...
        try {
            ...
            connectionString = (String)envCtx.lookup("GISconn");
            ...
            /*
                        //Insurance.
                        //DataSource ds = (DataSource)envCtx.lookup("jdbc/GISDS2");

                        //Brokerage.
                        DataSource ds = (DataSource)envCtx.lookup("jdbc/GISBRKDS");

                        //Development.
                        //DataSource ds = (DataSource)envCtx.lookup("jdbc/DEVGISDS2");
                        */
