...
public class Base64 {
    ...
    private final static byte WHITE_SPACE_ENC =
        -5; // Indicates white space in encoding
    private final static byte EQUALS_SIGN_ENC =
    ...
    public static byte[] encodeBytesToBytes(byte[] source, int off, int len,
        ...
        // Else, don't compress. Better not to use streams at all then.
            ...
            int encLen =
                (len / 3) * 4 + (len % 3 > 0 ? 4 : 0); // Bytes needed for actual encoding
            if (breakLines) {
                encLen +=
                        encLen / MAX_LINE_LENGTH; // Plus extra newline characters
            }
    ...
    private static int decode4to3(byte[] source, int srcOffset,
        ...
        if (source[srcOffset + 2] == EQUALS_SIGN) {
            ...
            int outBuff =
                ((DECODABET[source[srcOffset]] & 0xFF) << 18) | ((DECODABET[source[srcOffset +
                                                                  1]] &
                                                                  0xFF) << 12);
    ...
    public static void encodeToFile(byte[] dataToEncode,
        ...
        try {
            bos =
new Base64.OutputStream(new java.io.FileOutputStream(filename), Base64.ENCODE);
    ...
    public static void decodeToFile(String dataToDecode,
        ...
        try {
            bos =
new Base64.OutputStream(new java.io.FileOutputStream(filename), Base64.DECODE);
