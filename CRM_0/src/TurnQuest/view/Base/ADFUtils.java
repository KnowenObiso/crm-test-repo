...
public class ADFUtils {
    ...
    public static DCIteratorBinding findIterator(String name) {
        ...
        DCBindingContainer container=(DCBindingContainer)JSFUtils.resolveExpression("#{bindings}");
        if (container == null) {
            throw new RuntimeException("Unable to Resolve Bindings for this page! Update file DataBindings.cpx.");
        }
        DCIteratorBinding iter =container.findIteratorBinding(name.trim());
        if (iter == null) {
